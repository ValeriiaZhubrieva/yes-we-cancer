(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            ...
            if (e.target.closest(".header__btn") || e.target.closest(".dropdown-menu__link")) menuClose();
        }));
    }
    function menuClose() {
        bodyUnlock();
    ...
    function initSliders() {
        if (document.querySelector(".events__slider")) new Swiper(".events__slider", {
            ...
            pagination: {
                ...
                renderBullet: function(index, className) {
                    return `<span class="${className}"><span class="swiper-pagination-number">${index + 1}</span></span>`;
                }
            },
            navigation: {
                prevEl: ".swiper-button-prev",
